...
| R3 | 註冊與基本資料維護 | UC-01 | High | {{待填寫}} |
| R4 | 刊登建立/編輯/刪除（CRUD） | UC-02 | High | {{待填寫}} |
...
* **測試目標達成狀況：** 依測試計畫涵蓋 UC-01~UC-08（認證、刊登、搜尋、提案、協商聊天、配送設定、物流追蹤、送達確認）與 Web 架構、非功能性測試（安全/效能/恢復/壓力）。
	* 結論：{{待填寫：整體達成情況}}（例如：主要功能均可運作，部分情境需優化或修正）。
* **整體品質評估：** {{待填寫：品質評估}}（穩定 / 有風險 / 不穩定）。
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TC-AU01 | 帳密成功登入 | 有效帳號+正確密碼 | {{Pass/Fail}} | 200；導向首頁；會話建立；審計登入事件 | {{頁面/回應/審計}} | {{ID/NA}} |
| TC-AU02 | 密碼錯誤 | 有效帳號+錯誤密碼 | {{Pass/Fail}} | 401；停留登入頁；錯誤提示；無會話；審計失敗 | {{頁面/回應/審計}} | {{ID/NA}} |
| TC-AU03 | 帳號不存在 | 不存在帳號 | {{Pass/Fail}} | 404/401；錯誤提示；無會話 | {{回應/頁面}} | {{ID/NA}} |
| TC-AU04 | 密碼長度邊界 | 最短/最長 | {{Pass/Fail}} | 400（不符策略）或成功；提示清楚 | {{頁面/回應}} | {{ID/NA}} |
| TC-AU05 | OAuth 成功 | Google 回調有效 Code | {{Pass/Fail}} | 302→首頁；綁定會話；審計記錄 | {{回應/審計}} | {{ID/NA}} |
| TC-AU06 | OAuth 拒絕 | 授權失敗 | {{Pass/Fail}} | 302→登入頁；顯示拒絕訊息；無會話 | {{頁面/回應}} | {{ID/NA}} |
| TC-AU07 | 登出 | 已登入使用者 | {{Pass/Fail}} | 302→登入頁；會話清除；審計記錄 | {{頁面/審計}} | {{ID/NA}} |
| TC-AU08 | 註冊成功 | 合法 Email/暱稱/密碼 | {{Pass/Fail}} | 201；導向登入或自動登入；DB 建立使用者 | {{回應/DB}} | {{ID/NA}} |
| TC-AU09 | 註冊異常 | 非法 Email/空值/弱密碼 | {{Pass/Fail}} | 400；欄位錯誤提示；DB 不新增 | {{頁面/回應}} | {{ID/NA}} |
| TC-AU10 | 暴力嘗試 | 多次錯誤登入 | {{Pass/Fail}} | 429 或鎖定策略；審計告警 | {{安全Log/審計}} | {{ID/NA}} |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| TC-LS01 | 建立成功 | 合法名稱/分類/圖片 | {{Pass/Fail}} | 201；導向「我的刊登」；DB 新增 | {{連結/圖/請求/回應}} | {{ID/NA}} |
| TC-LS02 | 名稱邊界 | 最短/最長 | {{Pass/Fail}} | 400 或成功；訊息清楚；DB 一致 | {{圖/Log}} | {{ID/NA}} |
| TC-LS03 | 非法圖片 | 不支援類型 | {{Pass/Fail}} | 400；提示錯誤；不儲存 | {{圖/Log}} | {{ID/NA}} |
| TC-LS04 | 編輯刊登 | 變更描述/分類 | {{Pass/Fail}} | 200；資料更新；審計記錄 | {{圖/Log}} | {{ID/NA}} |
| TC-LS05 | 刪除刊登 | 擁有者操作 | {{Pass/Fail}} | 200；刪除/標記；列表不顯示 | {{圖/Log}} | {{ID/NA}} |
| TC-LS06 | 越權編修 | 非擁有者 | {{Pass/Fail}} | 403；不變更；審計記錄 | {{圖/Log}} | {{ID/NA}} |
| TC-LS07 | 列表顯示 | 多筆資料 | {{Pass/Fail}} | 200；分頁正確 | {{圖/Log}} | {{ID/NA}} |
...
### 6.1 缺陷分佈（依嚴重性）
- 致命 (Critical)：{{待填寫：數量}}（系統崩潰、資料遺失）
- 嚴重 (Major)：{{待填寫：數量}}（功能失效、安全性漏洞） → 上線前必修
	- 例：{{待填寫：Bug ID/說明}}
- 一般 (Minor)：{{待填寫：數量}}（功能瑕疵但有替代方案）
- 輕微 (Cosmetic)：{{待填寫：數量}}（排版、文案）
