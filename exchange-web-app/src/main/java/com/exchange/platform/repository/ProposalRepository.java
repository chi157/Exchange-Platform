...
public interface ProposalRepository extends JpaRepository<Proposal, Long> {
	...
	@Query("SELECT DISTINCT p FROM Proposal p LEFT JOIN FETCH p.proposalItems pi LEFT JOIN FETCH pi.listing WHERE p.receiverIdLegacy = :receiverId")
	Page<Proposal> findByReceiverIdLegacyWithItems(@Param("receiverId") Long receiverId, Pageable pageable);
